...
Thank you for your interest in `loopback-cli`, an open source project
administered by StrongLoop.

Contributing to `loopback-cli` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-cli)
